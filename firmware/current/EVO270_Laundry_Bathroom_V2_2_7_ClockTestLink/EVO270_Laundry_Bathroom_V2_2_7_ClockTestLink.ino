/*
  EVOHeat EVO270-1 - Bathroom / Laundry HWS
  ...
  UNIT IDENTITY
  -------------
  EVO270 – Bathroom & Laundry 34EAE7B41FEA
  Aqua Temp / HA prefix: 34eae7b41fea
  Serial: A022106088050
  Legacy climate: climate.34eae7b41fea
...
static const char *DEVICE_CODE_UP = "34EAE7B41FEA";
...
static const char *MQTT_AVAIL_TOPIC = "evo270/34eae7b41fea/availability";

static const uint8_t MODBUS_SLAVE = 99;

// H30 / register 1076 has been confirmed as 1 on the Bathroom & Laundry unit.
...
void publishOperatingModeSelectDiscovery() {
  ...
  payload += "\"default_entity_id\":\"select.backyard_evo270_bathroom_laundry_" +
...
void removeDiscoveryConfig(const char *component, const char *objectId) {
  String topic =
    "homeassistant/" + String(component) + "/evo270_laundry_bathroom_" +
...
String mainWebPage() {
  String page = webHeader("EVO270 Bathroom & Laundry");
  page.reserve(36000);

  page += "<h1>EVOHeat Bathroom &amp; Laundry</h1>";
...
void setup() {
  ...
  Serial.println();
  Serial.println("============================================================");
  Serial.println(" EVO270 BATHROOM / LAUNDRY - V2.2.7 LEGACY MAP - VERIFIED WRITES + CLOCK DIAGNOSTICS");
  Serial.println("============================================================");
